...
export async function initIntro() {
  ...
  welcomeContainer.setAttribute("aria-hidden", "true"); // Dold initialt för skärmläsare
  ...
  // Gör intro synlig för skärmläsare innan fade-in
  welcomeContainer.setAttribute("aria-hidden", "false");
